# Template Specification: Azure Royale

## 1. TEMPLATE OVERVIEW
- **Template Name:** Azure Royale
- **Template ID:** `TPL-HIN-05`
- **Slug:** `azure-royale`
- **Category:** Hinduism
- **Religious / Cultural Category:** Jodhpur Blue Palace / Peacock Darbar Heritage
- **Price / Tier:** ₹1,299
- **Reference URL:** [https://saveourdate.in/templates/azure-royale](https://saveourdate.in/templates/azure-royale)
- **Live Demo URL:** [https://saveourdate.in/templates/azure-royale/live](https://saveourdate.in/templates/azure-royale/live)

### Design Language & Visual Direction
- **Visual Direction:** Jodhpur Royal Blue / Stained Glass Palace Arches / Gilded Chandeliers & Peacocks
- **Primary Mood:** Aristocratic / Regal / Striking / Grandeur
- **Visual Density:** High (Ornate royal blue jali, stained glass reflections, gold foil chandeliers)
- **Animation Intensity:** High (Dual royal blue Jodhpur palace archways swinging inward, stained glass flare)
- **Color Palette Breakdown:**
  - Primary Background: `#0B2545`
  - Secondary Tone: `#EEF4F8`
  - Accent Color: `#EEB902`
  - Dark Accent: `#134074`
  - Neutral Dark / Text: `#05101E`
  - Card Glass Surface: `rgba(11, 37, 69, 0.94)`
- **Typography Matrix:**
...
The end-to-end guest journey for **Azure Royale** follows this sequence:

1. **Initial Page Load:** Full-viewport branded staging layer with delicate background motif and pulsing hint.
2. **Opening Screen Presentation:** The custom **Dual Jodhpur Royal Blue Palace Archway Swing Opening with Stained Glass Flare** covers the entire screen, preventing accidental content leak while awaiting user gesture.
...
6. **Smooth Downward Scroll:** Guest scrolls down at their own pace; floating decorative elements (Floating Blue Peacock Feathers, Stained Glass Light Rays & Gold Dust) subtly drift across the screen.
...
- **Loading Screen Visuals:** Minimalist full-screen container colored in `#0B2545` with a subtle radial gradient glow (`#EEB902` at 15% opacity).
...
- **Opening Mechanism:** Dual Jodhpur Royal Blue Palace Archway Swing Opening with Stained Glass Flare
- **Initial Visual State:**
  - Split panels or layered envelope flaps positioned over the viewport at `z-index: 50`.
  - Intricate decorative borders matching the **Azure Royale** visual aesthetic (`#EEB902` metallic filigree).
...
- **Active Decorative Elements:** Floating Blue Peacock Feathers, Stained Glass Light Rays & Gold Dust
...
- **Content Hierarchy:**
  ...
  3. **Bride & Groom Names:** Large serif display typography (`Cinzel Decorative, serif`), colored in `#134074` or `#EEF4F8`, separated by an artistic ampersand (`&`) or infinity knot.
...
## 15. VENUE / MAP
- **Map Integration:** Embedded Google Maps container styled with custom warm stone/monochrome map skin matching `#0B2545`.
...
- **Form Inputs:** Active floating labels and shimmering gold outline focus rings (`ring-2 ring-[#EEB902]`).
...
- `<AzureRoyaleOpening />` (Custom Dual Jodhpur Royal Blue Palace Archway Swing Opening with Stained Glass Flare)
- `<AzureRoyaleHero />`
- `<AzureRoyaleDecorations />`
...
```typescript
export const azure_royale_Config = {
  templateId: "TPL-HIN-05",
  slug: "azure-royale",
  name: "Azure Royale",
  category: "Hinduism",
  theme: {
  ...
  decorations: {
    floatingElements: "Floating Blue Peacock Feathers, Stained Glass Light Rays & Gold Dust",
...
## 28. ASSET INVENTORY
- **Decorative SVGs:**
  - Arch frames: `/templates/azure-royale/assets/arch-frame.svg`
  - Floral corner motifs: `/templates/azure-royale/assets/corner-flourish.svg`
  - Seal / Monogram frame: `/templates/azure-royale/assets/seal-crest.svg`
  - Divider flourishes: `/templates/azure-royale/assets/divider.svg`
- **Audio Assets:**
  - Ambient soundtrack: `/templates/azure-royale/audio/ambient-track.mp3`
...
- `01-initial-gate.png`: Initial locked viewport state with "Dual Jodhpur Royal Blue Palace Archway Swing Opening with Stained Glass Flare" prompt.
...
- **Recommended Opening Component:** `<AzureRoyaleOpening />` using Framer Motion spring orchestration.
- **Recommended Hero Component:** `<AzureRoyaleHero />` with staggered serif text reveals.
...
- **Template Architecture:** Driven purely by normalized `WeddingData` and template configuration (`azure_royale_Config`).
