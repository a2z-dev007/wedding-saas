# Template Specification: Noor-e-Nikah

## 1. TEMPLATE OVERVIEW
- **Template Name:** Noor-e-Nikah
- **Template ID:** `TPL-ISL-04`
- **Slug:** `noor-e-nikah`
- **Category:** Islamic
- **Religious / Cultural Category:** Spiritual Radiance / Pastel Rose & Pearl
- **Price / Tier:** ₹1,199
- **Reference URL:** [https://saveourdate.in/templates/noor-e-nikah](https://saveourdate.in/templates/noor-e-nikah)
- **Live Demo URL:** [https://saveourdate.in/templates/noor-e-nikah/live](https://saveourdate.in/templates/noor-e-nikah/live)

### Design Language & Visual Direction
- **Visual Direction:** Radiant Pearl Light (Noor) / Soft Rose Quartz / Delicate Crescent & Star Lattice
- **Primary Mood:** Ethereal / Luminous / Divine / Tender
- **Visual Density:** Medium (Soft radial glow, mother-of-pearl gradients, fine rose gold wirework)
- **Animation Intensity:** High (Glowing Noor light beam expansion, translucent silk curtains floating aside)
- **Color Palette Breakdown:**
  - Primary Background: `#FBF9F5`
  - Secondary Tone: `#C98E82`
  - Accent Color: `#E8D5B5`
  - Dark Accent: `#2E5A44`
  - Neutral Dark / Text: `#2C1E21`
  - Card Glass Surface: `rgba(251, 249, 245, 0.95)`
- **Typography Matrix:**
  - Display Headline: `Cormorant Garamond Italic, serif`
  - Subheadings: `Playfair Display, serif`
  - Body Text: `Montserrat, sans-serif`
  - Accent Calligraphy: `Scheherazade New, serif`

---

## 2. COMPLETE USER EXPERIENCE
The end-to-end guest journey for **Noor-e-Nikah** follows this sequence:

1. **Initial Page Load:** Full-viewport branded staging layer with delicate background motif and pulsing hint.
2. **Opening Screen Presentation:** The custom **Radiant Noor Light Glow & Dual Translucent Silk Nikah Curtains Parting** covers the entire screen, preventing accidental content leak while awaiting user gesture.
...
6. **Smooth Downward Scroll:** Guest scrolls down at their own pace; floating decorative elements (Soft Glowing Light Orbs, Rose Petals & Golden Shimmer Dust) subtly drift across the screen.
...
- **Loading Screen Visuals:** Minimalist full-screen container colored in `#FBF9F5` with a subtle radial gradient glow (`#E8D5B5` at 15% opacity).
...
- **Opening Mechanism:** Radiant Noor Light Glow & Dual Translucent Silk Nikah Curtains Parting
- **Initial Visual State:**
  - Split panels or layered envelope flaps positioned over the viewport at `z-index: 50`.
  - Intricate decorative borders matching the **Noor-e-Nikah** visual aesthetic (`#E8D5B5` metallic filigree).
...
- **Active Decorative Elements:** Soft Glowing Light Orbs, Rose Petals & Golden Shimmer Dust
...
- **Content Hierarchy:**
  ...
  3. **Bride & Groom Names:** Large serif display typography (`Cormorant Garamond Italic, serif`), colored in `#2E5A44` or `#C98E82`, separated by an artistic ampersand (`&`) or infinity knot.
...
## 15. VENUE / MAP
- **Map Integration:** Embedded Google Maps container styled with custom warm stone/monochrome map skin matching `#FBF9F5`.
...
- **Form Inputs:** Active floating labels and shimmering gold outline focus rings (`ring-2 ring-[#E8D5B5]`).
...
- `<NoorENikahOpening />` (Custom Radiant Noor Light Glow & Dual Translucent Silk Nikah Curtains Parting)
- `<NoorENikahHero />`
- `<NoorENikahDecorations />`
...
```typescript
export const noor_e_nikah_Config = {
  templateId: "TPL-ISL-04",
  slug: "noor-e-nikah",
  name: "Noor-e-Nikah",
  category: "Islamic",
  theme: {
    colors: {
      ...
      darkAccent: "#2E5A44",
      neutralDark: "#2C1E21",
      cardBg: "rgba(251, 249, 245, 0.95)",
    },
    typography: {
      display: "Cormorant Garamond Italic, serif",
      subheading: "Playfair Display, serif",
      body: "Montserrat, sans-serif",
      accentScript: "Scheherazade New, serif",
    },
  },
  opening: {
    type: "curtain-reveal",
  ...
  decorations: {
    floatingElements: "Soft Glowing Light Orbs, Rose Petals & Golden Shimmer Dust",
...
## 28. ASSET INVENTORY
- **Decorative SVGs:**
  - Arch frames: `/templates/noor-e-nikah/assets/arch-frame.svg`
  - Floral corner motifs: `/templates/noor-e-nikah/assets/corner-flourish.svg`
  - Seal / Monogram frame: `/templates/noor-e-nikah/assets/seal-crest.svg`
  - Divider flourishes: `/templates/noor-e-nikah/assets/divider.svg`
- **Audio Assets:**
  - Ambient soundtrack: `/templates/noor-e-nikah/audio/ambient-track.mp3`
...
- `01-initial-gate.png`: Initial locked viewport state with "Radiant Noor Light Glow & Dual Translucent Silk Nikah Curtains Parting" prompt.
...
- **Recommended Opening Component:** `<NoorENikahOpening />` using Framer Motion spring orchestration.
- **Recommended Hero Component:** `<NoorENikahHero />` with staggered serif text reveals.
...
- **Template Architecture:** Driven purely by normalized `WeddingData` and template configuration (`noor_e_nikah_Config`).
