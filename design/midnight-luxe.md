# Template Specification: Midnight Luxe

## 1. TEMPLATE OVERVIEW
- **Template Name:** Midnight Luxe
- **Template ID:** `TPL-NON-03`
- **Slug:** `midnight-luxe`
- **Category:** Non-Religious
- **Religious / Cultural Category:** Celestial Black Tie / High Fashion Editorial
- **Price / Tier:** ₹1,199
- **Reference URL:** [https://saveourdate.in/templates/midnight-luxe](https://saveourdate.in/templates/midnight-luxe)
- **Live Demo URL:** [https://saveourdate.in/templates/midnight-luxe/live](https://saveourdate.in/templates/midnight-luxe/live)

### Design Language & Visual Direction
- **Visual Direction:** Midnight Obsidian & Champagne Gold / Constellation Map / Vogue Editorial
- **Primary Mood:** Sleek / Glamorous / Mysterious / Ultra-Modern
- **Visual Density:** Medium (Deep black contrast, sharp gold geometry, fine typography)
- **Animation Intensity:** High (Constellation star map flare, midnight gate unlock, gold particle burst)
- **Color Palette Breakdown:**
  - Primary Background: `#0D1117`
  - Secondary Tone: `#FFFFFF`
  - Accent Color: `#E5C378`
  - Dark Accent: `#161B22`
  - Neutral Dark / Text: `#05070A`
  - Card Glass Surface: `rgba(22, 27, 34, 0.92)`
- **Typography Matrix:**
  - Display Headline: `Bodoni Moda, serif`
  - Subheadings: `Syncopate, sans-serif`
...
The end-to-end guest journey for **Midnight Luxe** follows this sequence:

1. **Initial Page Load:** Full-viewport branded staging layer with delicate background motif and pulsing hint.
2. **Opening Screen Presentation:** The custom **Celestial Star Map Constellation Flare & Dark Obsidian Gate Parting** covers the entire screen, preventing accidental content leak while awaiting user gesture.
...
6. **Smooth Downward Scroll:** Guest scrolls down at their own pace; floating decorative elements (Twinkling Constellation Stars & Orbiting Gold Light Orbs) subtly drift across the screen.
...
- **Loading Screen Visuals:** Minimalist full-screen container colored in `#0D1117` with a subtle radial gradient glow (`#E5C378` at 15% opacity).
...
- **Opening Mechanism:** Celestial Star Map Constellation Flare & Dark Obsidian Gate Parting
- **Initial Visual State:**
  - Split panels or layered envelope flaps positioned over the viewport at `z-index: 50`.
  - Intricate decorative borders matching the **Midnight Luxe** visual aesthetic (`#E5C378` metallic filigree).
...
- **Active Decorative Elements:** Twinkling Constellation Stars & Orbiting Gold Light Orbs
...
- **Content Hierarchy:**
  1. **Top Eyebrow:** Auspicious blessing / Tagline in uppercase tracking `0.25em` (`Syncopate, sans-serif`).
  2. **Couple Monogram / Emblem:** Centered crest featuring stylized initials.
  3. **Bride & Groom Names:** Large serif display typography (`Bodoni Moda, serif`), colored in `#161B22` or `#FFFFFF`, separated by an artistic ampersand (`&`) or infinity knot.
...
## 15. VENUE / MAP
- **Map Integration:** Embedded Google Maps container styled with custom warm stone/monochrome map skin matching `#0D1117`.
...
- **Form Inputs:** Active floating labels and shimmering gold outline focus rings (`ring-2 ring-[#E5C378]`).
...
- `<MidnightLuxeOpening />` (Custom Celestial Star Map Constellation Flare & Dark Obsidian Gate Parting)
- `<MidnightLuxeHero />`
- `<MidnightLuxeDecorations />`
...
```typescript
export const midnight_luxe_Config = {
  templateId: "TPL-NON-03",
  slug: "midnight-luxe",
  name: "Midnight Luxe",
  category: "Non-Religious",
  theme: {
    ...
    typography: {
      ...
      subheading: "Syncopate, sans-serif",
  ...
  decorations: {
    floatingElements: "Twinkling Constellation Stars & Orbiting Gold Light Orbs",
...
## 28. ASSET INVENTORY
- **Decorative SVGs:**
  - Arch frames: `/templates/midnight-luxe/assets/arch-frame.svg`
  - Floral corner motifs: `/templates/midnight-luxe/assets/corner-flourish.svg`
  - Seal / Monogram frame: `/templates/midnight-luxe/assets/seal-crest.svg`
  - Divider flourishes: `/templates/midnight-luxe/assets/divider.svg`
- **Audio Assets:**
  - Ambient soundtrack: `/templates/midnight-luxe/audio/ambient-track.mp3`
...
- `01-initial-gate.png`: Initial locked viewport state with "Celestial Star Map Constellation Flare & Dark Obsidian Gate Parting" prompt.
...
- **Recommended Opening Component:** `<MidnightLuxeOpening />` using Framer Motion spring orchestration.
- **Recommended Hero Component:** `<MidnightLuxeHero />` with staggered serif text reveals.
...
- **Template Architecture:** Driven purely by normalized `WeddingData` and template configuration (`midnight_luxe_Config`).
