# Template Specification: Gilded Veil

## 1. TEMPLATE OVERVIEW
- **Template Name:** Gilded Veil
- **Template ID:** `TPL-NON-07`
- **Slug:** `gilded-veil`
- **Category:** Non-Religious
- **Religious / Cultural Category:** High Fashion Organza / Haute Couture Minimalism
- **Price / Tier:** ₹1,099
- **Reference URL:** [https://saveourdate.in/templates/gilded-veil](https://saveourdate.in/templates/gilded-veil)
- **Live Demo URL:** [https://saveourdate.in/templates/gilded-veil/live](https://saveourdate.in/templates/gilded-veil/live)

### Design Language & Visual Direction
- **Visual Direction:** Translucent Shimmering Veil / Champagne Nude / Editorial Fashion Layout
- **Primary Mood:** Chic / Ethereal / Modern Haute Couture / Sensual
- **Visual Density:** Low-Medium (Generous negative space, fine serif headlines, sheer frosted glass overlays)
- **Animation Intensity:** Medium-High (Translucent organza veil lifting upward with wind physics, soft bokeh shimmer)
- **Color Palette Breakdown:**
  - Primary Background: `#FAF8F5`
  - Secondary Tone: `#A77B56`
  - Accent Color: `#EED9C4`
  - Dark Accent: `#5C3D2E`
  - Neutral Dark / Text: `#121212`
  - Card Glass Surface: `rgba(250, 248, 245, 0.9)`
- **Typography Matrix:**
  - Display Headline: `Cormorant Garamond, serif`
  - Subheadings: `Helvetica Neue / Inter, sans-serif`
  - Body Text: `Geist Sans, sans-serif`
  - Accent Calligraphy: `Corinthia / Italianno, cursive`

---

## 2. COMPLETE USER EXPERIENCE
The end-to-end guest journey for **Gilded Veil** follows this sequence:

1. **Initial Page Load:** Full-viewport branded staging layer with delicate background motif and pulsing hint.
2. **Opening Screen Presentation:** The custom **Translucent Gilded Shimmer Veil Lifting Upward with Wind Ripple Effect** covers the entire screen, preventing accidental content leak while awaiting user gesture.
...
6. **Smooth Downward Scroll:** Guest scrolls down at their own pace; floating decorative elements (Soft Sheer Organza Fabric Ripples, Champagne Bokeh Glow & Fine Bronze Particles) subtly drift across the screen.
...
- **Loading Screen Visuals:** Minimalist full-screen container colored in `#FAF8F5` with a subtle radial gradient glow (`#EED9C4` at 15% opacity).
...
- **Opening Mechanism:** Translucent Gilded Shimmer Veil Lifting Upward with Wind Ripple Effect
- **Initial Visual State:**
  - Split panels or layered envelope flaps positioned over the viewport at `z-index: 50`.
  - Intricate decorative borders matching the **Gilded Veil** visual aesthetic (`#EED9C4` metallic filigree).
...
- **Active Decorative Elements:** Soft Sheer Organza Fabric Ripples, Champagne Bokeh Glow & Fine Bronze Particles
...
- **Content Hierarchy:**
  1. **Top Eyebrow:** Auspicious blessing / Tagline in uppercase tracking `0.25em` (`Helvetica Neue / Inter, sans-serif`).
  2. **Couple Monogram / Emblem:** Centered crest featuring stylized initials.
  3. **Bride & Groom Names:** Large serif display typography (`Cormorant Garamond, serif`), colored in `#5C3D2E` or `#A77B56`, separated by an artistic ampersand (`&`) or infinity knot.
...
## 15. VENUE / MAP
- **Map Integration:** Embedded Google Maps container styled with custom warm stone/monochrome map skin matching `#FAF8F5`.
...
- **Form Inputs:** Active floating labels and shimmering gold outline focus rings (`ring-2 ring-[#EED9C4]`).
...
- `<GildedVeilOpening />` (Custom Translucent Gilded Shimmer Veil Lifting Upward with Wind Ripple Effect)
- `<GildedVeilHero />`
- `<GildedVeilDecorations />`
...
```typescript
export const gilded_veil_Config = {
  templateId: "TPL-NON-07",
  slug: "gilded-veil",
  name: "Gilded Veil",
  category: "Non-Religious",
  theme: {
    colors: {
      ...
      darkAccent: "#5C3D2E",
      neutralDark: "#121212",
      cardBg: "rgba(250, 248, 245, 0.9)",
    },
    typography: {
      display: "Cormorant Garamond, serif",
      subheading: "Helvetica Neue / Inter, sans-serif",
      body: "Geist Sans, sans-serif",
      accentScript: "Corinthia / Italianno, cursive",
    },
  },
  opening: {
    type: "veil-lift",
  ...
  decorations: {
    floatingElements: "Soft Sheer Organza Fabric Ripples, Champagne Bokeh Glow & Fine Bronze Particles",
...
## 28. ASSET INVENTORY
- **Decorative SVGs:**
  - Arch frames: `/templates/gilded-veil/assets/arch-frame.svg`
  - Floral corner motifs: `/templates/gilded-veil/assets/corner-flourish.svg`
  - Seal / Monogram frame: `/templates/gilded-veil/assets/seal-crest.svg`
  - Divider flourishes: `/templates/gilded-veil/assets/divider.svg`
- **Audio Assets:**
  - Ambient soundtrack: `/templates/gilded-veil/audio/ambient-track.mp3`
...
- `01-initial-gate.png`: Initial locked viewport state with "Translucent Gilded Shimmer Veil Lifting Upward with Wind Ripple Effect" prompt.
...
- **Recommended Opening Component:** `<GildedVeilOpening />` using Framer Motion spring orchestration.
- **Recommended Hero Component:** `<GildedVeilHero />` with staggered serif text reveals.
...
- **Template Architecture:** Driven purely by normalized `WeddingData` and template configuration (`gilded_veil_Config`).
