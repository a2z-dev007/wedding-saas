# Template Specification: Emerald Qasr

## 1. TEMPLATE OVERVIEW
- **Template Name:** Emerald Qasr
- **Template ID:** `TPL-ISL-02`
- **Slug:** `emerald-qasr`
- **Category:** Islamic
- **Religious / Cultural Category:** Ottoman & Mughal Palace Nikah
- **Price / Tier:** ₹1,299
- **Reference URL:** [https://saveourdate.in/templates/emerald-qasr](https://saveourdate.in/templates/emerald-qasr)
- **Live Demo URL:** [https://saveourdate.in/templates/emerald-qasr/live](https://saveourdate.in/templates/emerald-qasr/live)

### Design Language & Visual Direction
- **Visual Direction:** Deep Emerald Marble / Grand Qasr Arches / Gilded Arabesque Foliage
- **Primary Mood:** Majestic / Regal / Spiritual / Imposing Luxury
- **Visual Density:** High (Polished marble textures, golden filigree minarets, intricate arabesque borders)
- **Animation Intensity:** High (Dual grand Qasr palace doors parting, golden lantern sway, ambient nasheed unlock)
- **Color Palette Breakdown:**
  - Primary Background: `#043927`
  - Secondary Tone: `#F8F9FA`
  - Accent Color: `#C89D3C`
  - Dark Accent: `#0A4D36`
  - Neutral Dark / Text: `#081D14`
  - Card Glass Surface: `rgba(4, 57, 39, 0.94)`
- **Typography Matrix:**
  - Display Headline: `Cinzel Decorative, serif`
  - Subheadings: `Playfair Display, serif`
  - Body Text: `Tajawal / Lato, sans-serif`
  - Accent Calligraphy: `Amiri, serif`

---

## 2. COMPLETE USER EXPERIENCE
The end-to-end guest journey for **Emerald Qasr** follows this sequence:

1. **Initial Page Load:** Full-viewport branded staging layer with delicate background motif and pulsing hint.
2. **Opening Screen Presentation:** The custom **Grand Arched Qasr Palace Gates with Golden Lattice Parting** covers the entire screen, preventing accidental content leak while awaiting user gesture.
...
6. **Smooth Downward Scroll:** Guest scrolls down at their own pace; floating decorative elements (Swaying Golden Moroccan Lanterns, Soft Star Particles & Rose Water Droplets) subtly drift across the screen.
...
- **Loading Screen Visuals:** Minimalist full-screen container colored in `#043927` with a subtle radial gradient glow (`#C89D3C` at 15% opacity).
...
- **Opening Mechanism:** Grand Arched Qasr Palace Gates with Golden Lattice Parting
- **Initial Visual State:**
  - Split panels or layered envelope flaps positioned over the viewport at `z-index: 50`.
  - Intricate decorative borders matching the **Emerald Qasr** visual aesthetic (`#C89D3C` metallic filigree).
...
- **Active Decorative Elements:** Swaying Golden Moroccan Lanterns, Soft Star Particles & Rose Water Droplets
...
- **Content Hierarchy:**
  ...
  3. **Bride & Groom Names:** Large serif display typography (`Cinzel Decorative, serif`), colored in `#0A4D36` or `#F8F9FA`, separated by an artistic ampersand (`&`) or infinity knot.
...
## 15. VENUE / MAP
- **Map Integration:** Embedded Google Maps container styled with custom warm stone/monochrome map skin matching `#043927`.
...
- **Form Inputs:** Active floating labels and shimmering gold outline focus rings (`ring-2 ring-[#C89D3C]`).
...
- `<EmeraldQasrOpening />` (Custom Grand Arched Qasr Palace Gates with Golden Lattice Parting)
- `<EmeraldQasrHero />`
- `<EmeraldQasrDecorations />`
...
```typescript
export const emerald_qasr_Config = {
  templateId: "TPL-ISL-02",
  slug: "emerald-qasr",
  name: "Emerald Qasr",
  category: "Islamic",
  theme: {
    colors: {
      ...
      darkAccent: "#0A4D36",
      neutralDark: "#081D14",
      cardBg: "rgba(4, 57, 39, 0.94)",
    },
    typography: {
      display: "Cinzel Decorative, serif",
      subheading: "Playfair Display, serif",
      body: "Tajawal / Lato, sans-serif",
      accentScript: "Amiri, serif",
    },
  },
  opening: {
    type: "palace-gate",
  ...
  decorations: {
    floatingElements: "Swaying Golden Moroccan Lanterns, Soft Star Particles & Rose Water Droplets",
...
## 28. ASSET INVENTORY
- **Decorative SVGs:**
  - Arch frames: `/templates/emerald-qasr/assets/arch-frame.svg`
  - Floral corner motifs: `/templates/emerald-qasr/assets/corner-flourish.svg`
  - Seal / Monogram frame: `/templates/emerald-qasr/assets/seal-crest.svg`
  - Divider flourishes: `/templates/emerald-qasr/assets/divider.svg`
- **Audio Assets:**
  - Ambient soundtrack: `/templates/emerald-qasr/audio/ambient-track.mp3`
...
- `01-initial-gate.png`: Initial locked viewport state with "Grand Arched Qasr Palace Gates with Golden Lattice Parting" prompt.
...
- **Recommended Opening Component:** `<EmeraldQasrOpening />` using Framer Motion spring orchestration.
- **Recommended Hero Component:** `<EmeraldQasrHero />` with staggered serif text reveals.
...
- **Template Architecture:** Driven purely by normalized `WeddingData` and template configuration (`emerald_qasr_Config`).
