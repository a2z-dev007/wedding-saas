# Template Specification: Emerald Royale

## 1. TEMPLATE OVERVIEW
- **Template Name:** Emerald Royale
- **Template ID:** `TPL-HIN-04`
- **Slug:** `emerald-royale`
- **Category:** Hinduism
- **Religious / Cultural Category:** Peacock Darbar / Imperial Emerald Heritage
- **Price / Tier:** ₹1,299
- **Reference URL:** [https://saveourdate.in/templates/emerald-royale](https://saveourdate.in/templates/emerald-royale)
- **Live Demo URL:** [https://saveourdate.in/templates/emerald-royale/live](https://saveourdate.in/templates/emerald-royale/live)

### Design Language & Visual Direction
- **Visual Direction:** Imperial Emerald Marble / Peacock Feather Gold / Ancient Temple Arches
- **Primary Mood:** Regal / Mystical / Majestic / Deep Heritage
- **Visual Density:** High (Intricate peacock jali, gold foil filigree, emerald stone textures)
- **Animation Intensity:** High (Double emerald palace door split, spreading peacock tail motif, floating gold particles)
- **Color Palette Breakdown:**
  - Primary Background: `#0A3B2C`
  - Secondary Tone: `#FDFBF7`
  - Accent Color: `#D4AF37`
  - Dark Accent: `#0E5A44`
  - Neutral Dark / Text: `#051E16`
  - Card Glass Surface: `rgba(10, 59, 44, 0.94)`
- **Typography Matrix:**
...
The end-to-end guest journey for **Emerald Royale** follows this sequence:

1. **Initial Page Load:** Full-viewport branded staging layer with delicate background motif and pulsing hint.
2. **Opening Screen Presentation:** The custom **Carved Emerald & Gold Peacock Darbar Doorway with Tap Interaction** covers the entire screen, preventing accidental content leak while awaiting user gesture.
...
6. **Smooth Downward Scroll:** Guest scrolls down at their own pace; floating decorative elements (Floating Peacock Feathers, Gold Dust Particles & Temple Floral Strings) subtly drift across the screen.
...
- **Loading Screen Visuals:** Minimalist full-screen container colored in `#0A3B2C` with a subtle radial gradient glow (`#D4AF37` at 15% opacity).
...
- **Opening Mechanism:** Carved Emerald & Gold Peacock Darbar Doorway with Tap Interaction
- **Initial Visual State:**
  - Split panels or layered envelope flaps positioned over the viewport at `z-index: 50`.
  - Intricate decorative borders matching the **Emerald Royale** visual aesthetic (`#D4AF37` metallic filigree).
...
- **Active Decorative Elements:** Floating Peacock Feathers, Gold Dust Particles & Temple Floral Strings
...
- **Content Hierarchy:**
  ...
  3. **Bride & Groom Names:** Large serif display typography (`Cinzel Decorative, serif`), colored in `#0E5A44` or `#FDFBF7`, separated by an artistic ampersand (`&`) or infinity knot.
...
## 15. VENUE / MAP
- **Map Integration:** Embedded Google Maps container styled with custom warm stone/monochrome map skin matching `#0A3B2C`.
...
- `<EmeraldRoyaleOpening />` (Custom Carved Emerald & Gold Peacock Darbar Doorway with Tap Interaction)
- `<EmeraldRoyaleHero />`
- `<EmeraldRoyaleDecorations />`
...
```typescript
export const emerald_royale_Config = {
  templateId: "TPL-HIN-04",
  slug: "emerald-royale",
  name: "Emerald Royale",
  category: "Hinduism",
  theme: {
  ...
  decorations: {
    floatingElements: "Floating Peacock Feathers, Gold Dust Particles & Temple Floral Strings",
...
## 28. ASSET INVENTORY
- **Decorative SVGs:**
  - Arch frames: `/templates/emerald-royale/assets/arch-frame.svg`
  - Floral corner motifs: `/templates/emerald-royale/assets/corner-flourish.svg`
  - Seal / Monogram frame: `/templates/emerald-royale/assets/seal-crest.svg`
  - Divider flourishes: `/templates/emerald-royale/assets/divider.svg`
- **Audio Assets:**
  - Ambient soundtrack: `/templates/emerald-royale/audio/ambient-track.mp3`
...
- `01-initial-gate.png`: Initial locked viewport state with "Carved Emerald & Gold Peacock Darbar Doorway with Tap Interaction" prompt.
...
- **Recommended Opening Component:** `<EmeraldRoyaleOpening />` using Framer Motion spring orchestration.
- **Recommended Hero Component:** `<EmeraldRoyaleHero />` with staggered serif text reveals.
...
- **Template Architecture:** Driven purely by normalized `WeddingData` and template configuration (`emerald_royale_Config`).
