# Template Specification: South Mandapam

## 1. TEMPLATE OVERVIEW
- **Template Name:** South Mandapam
- **Template ID:** `TPL-SOU-01`
- **Slug:** `south-mandapam`
- **Category:** South Indian
- **Religious / Cultural Category:** Vedic Kalyanam / Traditional Dravidian Temple Mandapam
- **Price / Tier:** ₹1,299
- **Reference URL:** [https://saveourdate.in/templates/south-mandapam](https://saveourdate.in/templates/south-mandapam)
- **Live Demo URL:** [https://saveourdate.in/templates/south-mandapam/live](https://saveourdate.in/templates/south-mandapam/live)

### Design Language & Visual Direction
- **Visual Direction:** Carved Teakwood Mandapam / Banana Leaf Green / Kanjeevaram Red & Temple Bells
- **Primary Mood:** Sacred / Auspicious / Traditional / Cultural Pride
- **Visual Density:** High (Kolam rangoli borders, hanging brass bells, marigold toran, mango leaf garlands)
- **Animation Intensity:** High (Carved wooden temple door opening, swinging brass bells with chime sound, falling yellow marigolds)
- **Color Palette Breakdown:**
  - Primary Background: `#FCFBF7`
  - Secondary Tone: `#990000`
  - Accent Color: `#D4AF37`
  - Dark Accent: `#2E7D32`
  - Neutral Dark / Text: `#3E1F00`
  - Card Glass Surface: `rgba(252, 251, 247, 0.96)`
- **Typography Matrix:**
  - Display Headline: `Cinzel, serif`
...
The end-to-end guest journey for **South Mandapam** follows this sequence:

1. **Initial Page Load:** Full-viewport branded staging layer with delicate background motif and pulsing hint.
2. **Opening Screen Presentation:** The custom **Brass-Clad Temple Sanctum Door Opening with Resonant Bell Chimes & Nadaswaram Audio Unlock** covers the entire screen, preventing accidental content leak while awaiting user gesture.
...
6. **Smooth Downward Scroll:** Guest scrolls down at their own pace; floating decorative elements (Swinging Brass Bells, Fresh Marigold Petals, Banana Leaves & Jasmine Strings) subtly drift across the screen.
...
- **Loading Screen Visuals:** Minimalist full-screen container colored in `#FCFBF7` with a subtle radial gradient glow (`#D4AF37` at 15% opacity).
...
- **Opening Mechanism:** Brass-Clad Temple Sanctum Door Opening with Resonant Bell Chimes & Nadaswaram Audio Unlock
- **Initial Visual State:**
  - Split panels or layered envelope flaps positioned over the viewport at `z-index: 50`.
  - Intricate decorative borders matching the **South Mandapam** visual aesthetic (`#D4AF37` metallic filigree).
...
- **Active Decorative Elements:** Swinging Brass Bells, Fresh Marigold Petals, Banana Leaves & Jasmine Strings
...
- **Content Hierarchy:**
  ...
  3. **Bride & Groom Names:** Large serif display typography (`Cinzel, serif`), colored in `#2E7D32` or `#990000`, separated by an artistic ampersand (`&`) or infinity knot.
...
## 15. VENUE / MAP
- **Map Integration:** Embedded Google Maps container styled with custom warm stone/monochrome map skin matching `#FCFBF7`.
...
- `<SouthMandapamOpening />` (Custom Brass-Clad Temple Sanctum Door Opening with Resonant Bell Chimes & Nadaswaram Audio Unlock)
- `<SouthMandapamHero />`
- `<SouthMandapamDecorations />`
...
```typescript
export const south_mandapam_Config = {
  templateId: "TPL-SOU-01",
  slug: "south-mandapam",
  name: "South Mandapam",
  category: "South Indian",
  theme: {
  ...
  decorations: {
    floatingElements: "Swinging Brass Bells, Fresh Marigold Petals, Banana Leaves & Jasmine Strings",
...
## 28. ASSET INVENTORY
- **Decorative SVGs:**
  - Arch frames: `/templates/south-mandapam/assets/arch-frame.svg`
  - Floral corner motifs: `/templates/south-mandapam/assets/corner-flourish.svg`
  - Seal / Monogram frame: `/templates/south-mandapam/assets/seal-crest.svg`
  - Divider flourishes: `/templates/south-mandapam/assets/divider.svg`
- **Audio Assets:**
  - Ambient soundtrack: `/templates/south-mandapam/audio/ambient-track.mp3`
...
- `01-initial-gate.png`: Initial locked viewport state with "Brass-Clad Temple Sanctum Door Opening with Resonant Bell Chimes & Nadaswaram Audio Unlock" prompt.
...
- **Recommended Opening Component:** `<SouthMandapamOpening />` using Framer Motion spring orchestration.
- **Recommended Hero Component:** `<SouthMandapamHero />` with staggered serif text reveals.
...
- **Template Architecture:** Driven purely by normalized `WeddingData` and template configuration (`south_mandapam_Config`).
