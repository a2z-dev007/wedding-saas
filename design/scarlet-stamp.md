# Template Specification: Scarlet Stamp

## 1. TEMPLATE OVERVIEW
- **Template Name:** Scarlet Stamp
- **Template ID:** `TPL-NON-05`
- **Slug:** `scarlet-stamp`
- **Category:** Non-Religious
- **Religious / Cultural Category:** Vintage Airmail Postage / Editorial Retro Romance
- **Price / Tier:** ₹999
- **Reference URL:** [https://saveourdate.in/templates/scarlet-stamp](https://saveourdate.in/templates/scarlet-stamp)
- **Live Demo URL:** [https://saveourdate.in/templates/scarlet-stamp/live](https://saveourdate.in/templates/scarlet-stamp/live)

### Design Language & Visual Direction
- **Visual Direction:** Deckle-Edge Parchment / Vintage Postage Stamps / Postmark Cancellation & Typewriter Font
- **Primary Mood:** Nostalgic / Whimsical / Intimate / Storybook
- **Visual Density:** Medium (Postal airmail stripes, wax stamp seals, vintage paper grain)
- **Animation Intensity:** Medium-High (Wax stamp cracking animation, vintage envelope flap opening, accordion folded letter slide)
- **Color Palette Breakdown:**
  - Primary Background: `#F5EBE0`
  - Secondary Tone: `#C0392B`
  - Accent Color: `#D4AF37`
  - Dark Accent: `#2B1E16`
  - Neutral Dark / Text: `#19110B`
  - Card Glass Surface: `rgba(245, 235, 224, 0.94)`
- **Typography Matrix:**
  - Display Headline: `Playfair Display, serif`
  - Subheadings: `Special Elite / Courier Prime, monospace`
...
The end-to-end guest journey for **Scarlet Stamp** follows this sequence:

1. **Initial Page Load:** Full-viewport branded staging layer with delicate background motif and pulsing hint.
2. **Opening Screen Presentation:** The custom **Scarlet Wax Stamp Break with Vintage Airmail Envelope Flap Opening** covers the entire screen, preventing accidental content leak while awaiting user gesture.
...
6. **Smooth Downward Scroll:** Guest scrolls down at their own pace; floating decorative elements (Floating Postcard Stamps, Red Postal Confetti & Antique Paper Flecks) subtly drift across the screen.
...
- **Loading Screen Visuals:** Minimalist full-screen container colored in `#F5EBE0` with a subtle radial gradient glow (`#D4AF37` at 15% opacity).
...
- **Opening Mechanism:** Scarlet Wax Stamp Break with Vintage Airmail Envelope Flap Opening
- **Initial Visual State:**
  - Split panels or layered envelope flaps positioned over the viewport at `z-index: 50`.
  - Intricate decorative borders matching the **Scarlet Stamp** visual aesthetic (`#D4AF37` metallic filigree).
...
- **Active Decorative Elements:** Floating Postcard Stamps, Red Postal Confetti & Antique Paper Flecks
...
- **Content Hierarchy:**
  1. **Top Eyebrow:** Auspicious blessing / Tagline in uppercase tracking `0.25em` (`Special Elite / Courier Prime, monospace`).
  2. **Couple Monogram / Emblem:** Centered crest featuring stylized initials.
  3. **Bride & Groom Names:** Large serif display typography (`Playfair Display, serif`), colored in `#2B1E16` or `#C0392B`, separated by an artistic ampersand (`&`) or infinity knot.
...
## 15. VENUE / MAP
- **Map Integration:** Embedded Google Maps container styled with custom warm stone/monochrome map skin matching `#F5EBE0`.
...
- `<ScarletStampOpening />` (Custom Scarlet Wax Stamp Break with Vintage Airmail Envelope Flap Opening)
- `<ScarletStampHero />`
- `<ScarletStampDecorations />`
...
```typescript
export const scarlet_stamp_Config = {
  templateId: "TPL-NON-05",
  slug: "scarlet-stamp",
  name: "Scarlet Stamp",
  category: "Non-Religious",
  theme: {
    colors: {
      ...
      darkAccent: "#2B1E16",
      neutralDark: "#19110B",
      cardBg: "rgba(245, 235, 224, 0.94)",
    },
    typography: {
      display: "Playfair Display, serif",
      subheading: "Special Elite / Courier Prime, monospace",
      body: "Inter, sans-serif",
      accentScript: "Pinyon Script, cursive",
    },
  },
  opening: {
    type: "envelope-wax-seal",
    autoPlayAudio: true,
    animationDuration: 1.2,
  },
  decorations: {
    floatingElements: "Floating Postcard Stamps, Red Postal Confetti & Antique Paper Flecks",
...
## 28. ASSET INVENTORY
- **Decorative SVGs:**
  - Arch frames: `/templates/scarlet-stamp/assets/arch-frame.svg`
  - Floral corner motifs: `/templates/scarlet-stamp/assets/corner-flourish.svg`
  - Seal / Monogram frame: `/templates/scarlet-stamp/assets/seal-crest.svg`
  - Divider flourishes: `/templates/scarlet-stamp/assets/divider.svg`
- **Audio Assets:**
  - Ambient soundtrack: `/templates/scarlet-stamp/audio/ambient-track.mp3`
...
- `01-initial-gate.png`: Initial locked viewport state with "Scarlet Wax Stamp Break with Vintage Airmail Envelope Flap Opening" prompt.
...
- **Recommended Opening Component:** `<ScarletStampOpening />` using Framer Motion spring orchestration.
- **Recommended Hero Component:** `<ScarletStampHero />` with staggered serif text reveals.
...
- **Template Architecture:** Driven purely by normalized `WeddingData` and template configuration (`scarlet_stamp_Config`).
